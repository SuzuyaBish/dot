...
lsp.on_attach(function(client, bufnr)
	...
	bind("n", "<leader>ls", "<Cmd>Lspsaga show_line_diagnostics<CR>", opts)
	bind("n", "N", "<cmd>Lspsaga diagnostic_jump_next<CR>", opts)
	bind("n", "M", "<cmd>Lspsaga diagnostic_jump_prev<CR>", opts)
	bind("n", "<leader>af", "<Cmd>Lspsaga code_action<CR>", opts)
end)
